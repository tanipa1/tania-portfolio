...
const Banner = () => {
    return (
        <Element name="section1" className="element">
            <div className='bg-[#EFFBF8] py-10 px-5 lg:flex justify-around  items-center'>
                <div className='lg:w-1/2 grid justify-center text-center lg:text-left'>
                    <h1 className='font-bold text-2xl lg:text-5xl'>Hi, I'm <span className='text-[#A5A6FF]'>Tania!</span></h1>
                    <TypeAnimation className='text-2xl'
                        ...
                        repeat={Infinity}
                    />
                    <p className='font-mono mt-8 text-justify lg:text-left text-xs lg:text-base '>
                    ...
                    <div className='mt-5'>
                        ...
                        <div className='grid gap-2 justify-center lg:justify-start text-xs lg:text-base'>
                            <div className='flex'>
